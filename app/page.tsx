      ...
      <section className="workspace-grid">
        <div className="main-column">
          ...
          <article className="card">
            ...
            <div className="form-grid three">
              <label>Região<input value={form.region} readOnly={locationsStatus !== "error"} onChange={(e) => update("region", e.target.value)} placeholder={locationsStatus === "loading" ? "Carregando…" : "Preenchida automaticamente"} /></label>
